package com.shcoding.data.repository
...
import com.shcoding.util.Constants.NEXT_PAGE_KEY
import com.shcoding.util.Constants.PREVIOUS_PAGE_KEY
...
class HeroRepositoryImpl : HeroRepository {
    ...
    override suspend fun getAllHeroes(page: Int): ServerResponse {
    ...
    override suspend fun searchHeroes(name: String?): ServerResponse {
